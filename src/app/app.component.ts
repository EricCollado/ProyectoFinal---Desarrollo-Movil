...
export class AppComponent {
  ...
  public appPages2 = [
    { title: 'Noticias', url: '/noticias-login', icon: 'newspaper'},
    { title: 'Reportar Situación', url: '/reportar-situa', icon: 'add-circle'},
    { title: 'Mis Situaciones', url: '/situaciones', icon: 'layers'},
    { title: 'Mapa De Situaciones', url: '/mapa-reporte', icon: 'map'},
    { title: 'Cambiar Contraseña', url: '/cambiar-p', icon: 'pencil'}
